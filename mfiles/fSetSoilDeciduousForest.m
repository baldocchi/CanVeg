function [soil] = fSetSoilDeciduousForest(met,prm, soil)
...
%        Soil water content 
 ...
 %       // Water content of litter. Values ranged between 0.02 and 0.126
  ...
  %   airborne fraction = porosity - volumetric water content
        ...
        soil.bulkdensity=1.25;     % g cm-3   Data from Tyler Anthony
        ...
        soil.clay_fraction = .63;      %//  Clay fraction   
        soil.sand_fraction = 0.34;
