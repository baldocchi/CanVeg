function [soil] = fSetSoilTule(met,prm, soil)
...
% for tules we are looking at the transfer of heat through the water column    
...
%        Soil water content 
 ...
 %       // Water content of litter. Values ranged between 0.02 and 0.126
        ...
        soil.water_content_litter = 1.0;   %// assumed constant but needs to vary
  ...
  % water column
        ...
        soil.bulkdensity=1.0;     % water gram per cm-3 g cm-3   
        ...
        %assuming water as lower boundary condition
        soil.pore_fraction=1.;
         
        soil.clay_fraction = .0;      %//  Clay fraction   
		soil.peat_fraction = 0.0;    %//  SOM = a C; C = 4.7%, a = 1.72  Kuno Kasak, 2019 Bouldin Alfalfa
       
        
		soil.mineral_fraction= 1-soil.pore_fraction -soil.peat_fraction ; % // from bulk density asssuming density of solids is 2.65
        soil.mineral_fraction=0; % water column
        
		soil.air_fraction = soil.pore_fraction - met.soilmoisture;
        soil.air_fraction = 0;   % water column
		...
		soil.K_org= 0.8;      % organic matter
		soil.K_water= 0.25;   % water
