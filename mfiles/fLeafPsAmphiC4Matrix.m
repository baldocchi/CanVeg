 function [ps]=fLeafPsAmphiC4Matrix(Iphoton,cca, Tlk, rb_co2, P_kPa, eair_Pa,prm)
 

%         12-17-2020, Leaf_photosynthesis model, Amphistomatous leaves  C4
...
% 
%             Collatz, G. J., M. Ribas-Carbo, and J. A. Berry. 1992. 
%            'Coupled photosynthesis-stomatal conductance model for leaves of C4 plants',
%             Australian Journal of Plant Physiology, 19: 519-38.

% 
%              Yin, X., and P. C. Struik. 2009. 'C3 and C4 photosynthesis models:
%   An overview from the perspective of crop modelling', NJAS - Wageningen Journal of Life Sciences, 57: 27-38.

% -----------------------------------------------------------------------
% 
%           A Biochemical Model of C4 Photosynthesis
% 


%    A =Wp - L

%  CO2 and O2 are evaluated at bundle sheaths
...
% */
       ...
       % Ball Berry is computed based on Anet
...
%          
 ...
 %output
         ...
         ps.gs_m_s=gs_m_s;     % conductance for water vapor
         ps.wj=wj;
         ps.wc=wc;
         ps.wp=wp;
